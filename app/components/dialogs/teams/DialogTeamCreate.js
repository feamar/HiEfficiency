...
export default class DialogTeamCreate extends AbstractDialog
{
    constructor(props)
    {
        super(props);
    ...
    onSave = () => 
    {
        ...
        {   this.props.onDialogSubmitted(this.state.fields);}
        ...
        return (
            <ScrollView>
                <View style={{marginLeft: 25, marginRight: 25}}>
                    ...
                    <TextInput name="code" label="Security Code" value={this.state.securityCode} onChangeText={this.onValueChanged("code")}/>
                </View>
            </ScrollView>
        );
    }
